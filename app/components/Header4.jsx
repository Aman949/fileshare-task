      ...
      <div className='grid sm:grid-cols-12 gap-2 sm:gap-4 sm:m-10'>
        <div className='sm:col-span-4'>
          <div className='grid sm:grid-cols-1 gap-4'>
            ...
            <div className='border border-white/80 shadow-xl rounded-lg p-4'>
              <div className='flex items-center p-4 gap-2'>
                <Image src='/graphic-design.svg' height={40} width={40} alt='graphic' />
            ...
            <div className='border border-white/80 shadow-xl rounded-lg p-4'>
              <div className='flex items-center p-4 gap-2'>
                <Image src='/coding-language.svg' height={40} width={40} alt='coding' />
        ...
        <div className='sm:col-span-4'>
          <div className='grid sm:grid-cols-1 gap-4'>
            ...
            <div className='border border-white/80 shadow-xl rounded-lg p-4'>
              ...
              <p className='pl-4'>We design the application page and publish it in the App Store and Google Play stores.</p>
            </div>
            <div className='border border-white/80 shadow-xl rounded-lg p-4'>
              <div className='flex items-center p-4 gap-2'>
